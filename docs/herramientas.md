...
| **markitdown** | ingesta: PDF/Office/imágenes → Markdown (CLI + MCP) | Python | MIT |
| **notebooklm-mcp** | conocimiento externo curado vía NotebookLM (cloud, manual) | Node + Chrome | MIT |
